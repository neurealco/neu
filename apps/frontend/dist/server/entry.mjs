...
import { manifest } from './manifest_DoNSF2Se.mjs';
...
const _page4 = () => import('./pages/dashboard/surveys.astro.mjs');
const _page5 = () => import('./pages/dashboard.astro.mjs');
const _page6 = () => import('./pages/documentation.astro.mjs');
const _page7 = () => import('./pages/features/_slug_.astro.mjs');
const _page8 = () => import('./pages/features.astro.mjs');
const _page9 = () => import('./pages/health.astro.mjs');
const _page10 = () => import('./pages/help/_slug_.astro.mjs');
const _page11 = () => import('./pages/help.astro.mjs');
const _page12 = () => import('./pages/login.astro.mjs');
const _page13 = () => import('./pages/payment-methods.astro.mjs');
const _page14 = () => import('./pages/pricing.astro.mjs');
const _page15 = () => import('./pages/privacy.astro.mjs');
const _page16 = () => import('./pages/security.astro.mjs');
const _page17 = () => import('./pages/social-media.astro.mjs');
const _page18 = () => import('./pages/terms-and-conditions.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/dashboard/surveys.astro", _page4],
    ["src/pages/dashboard/index.astro", _page5],
    ["src/pages/documentation/index.astro", _page6],
    ["src/pages/features/[slug].astro", _page7],
    ["src/pages/features/index.astro", _page8],
    ["src/pages/health.ts", _page9],
    ["src/pages/help/[slug].astro", _page10],
    ["src/pages/help/index.astro", _page11],
    ["src/pages/login.astro", _page12],
    ["src/pages/payment-methods/index.astro", _page13],
    ["src/pages/pricing.astro", _page14],
    ["src/pages/privacy/index.astro", _page15],
    ["src/pages/security/index.astro", _page16],
    ["src/pages/social-media/index.astro", _page17],
    ["src/pages/terms-and-conditions/index.astro", _page18],

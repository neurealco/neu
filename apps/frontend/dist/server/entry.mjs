...
import { manifest } from './manifest_BHfMfEZC.mjs';
...
const _page5 = () => import('./pages/features/_slug_.astro.mjs');
const _page6 = () => import('./pages/features.astro.mjs');
const _page7 = () => import('./pages/health.astro.mjs');
const _page8 = () => import('./pages/help/_slug_.astro.mjs');
const _page9 = () => import('./pages/help.astro.mjs');
const _page10 = () => import('./pages/login.astro.mjs');
const _page11 = () => import('./pages/payment-methods.astro.mjs');
const _page12 = () => import('./pages/pricing.astro.mjs');
const _page13 = () => import('./pages/privacy.astro.mjs');
const _page14 = () => import('./pages/security.astro.mjs');
const _page15 = () => import('./pages/social-media.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/documentation/index.astro", _page4],
    ["src/pages/features/[slug].astro", _page5],
    ["src/pages/features/index.astro", _page6],
    ["src/pages/health.ts", _page7],
    ["src/pages/help/[slug].astro", _page8],
    ["src/pages/help/index.astro", _page9],
    ["src/pages/login.astro", _page10],
    ["src/pages/payment-methods/index.astro", _page11],
    ["src/pages/pricing.astro", _page12],
    ["src/pages/privacy/index.astro", _page13],
    ["src/pages/security/index.astro", _page14],
    ["src/pages/social-media/index.astro", _page15],
    ["src/pages/terms-and-conditions/index.astro", _page16],

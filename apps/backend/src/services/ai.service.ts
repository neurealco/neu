...
const SPANISH_PROMPT_TEMPLATE = (history: string[], newMessage: string) => {
  let prompt =
    "Eres un experto asistente de YouTube especializado en crecimiento de canales, SEO y estrategias de contenido. Responde de forma concisa y profesional en español.\n\n";
